...
if __name__ == "__main__":
    ...
    command = "/tmp/runpilot2-wrapper.sh {0} -i PR -w generic --pilot-user=ATLAS --url=https://pandaserver.cern.ch -d --harvester-submit-mode={1} --allow-same-user=False  --piloturl http://cern.ch/atlas-panda-pilot/pilot2-2.5.4-PRE.tar.gz | tee /tmp/wrapper-wid.log".\
